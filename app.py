...
def webhook_viaFB():
    ...
    print(output)
    return jsonify({"messages": [{"attachment": {"type": "template", "payload": {"template_type": "generic", "elements": [{"title": "The most popular restaurants in town this week", "image_url": "https://b.zmtcdn.com/data/collections/e140962ec7eecbb851155fe0bb0cd28c_1463395649.jpg"}]}}}]})   	
